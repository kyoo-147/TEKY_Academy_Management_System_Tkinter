...
class nCourse():
    ...
    def labels(self):
        ...
        lblList.append(Label(self.rt,text="Tên khóa học",font=fntStyle))
    ...
    def saveFile(self):
        msgBox = messagebox.showinfo("Lưu","Đã thêm khóa học")
        nstds = {
    ...
    def svBttnHvr(self,e):
        self.svBtnLabel.config(text="Lưu khóa học",borderwidth=2,relief="ridge")
